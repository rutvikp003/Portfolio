...
import Beingfit from "../../Assets/Projects/BeingFit.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Beingfit"
              description="Beingfit is a comprehensive fitness and wellness platform that provides users with personalized workout plans, nutrition guidance, and progress tracking. The platform aims to make fitness accessible and enjoyable for everyone, regardless of their experience level."
              ghLink="https://github.com/rutvikp003/BeingFit_V1"
